...
export class UserController {
  ...
  async handleGetUserProfileByEmail(@Payload() data: { email: string }): Promise<UserResponseDto | null> {
  ...
  async handleGetUserProfileById(@Payload() data: { id: string }): Promise<UserResponseDto | null> {
