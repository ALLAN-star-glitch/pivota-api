...
@ApiTags('Providers Pricing Module - ((Listings-Service) - MICROSERVICE)')
@Controller('providers-pricing')
export class ProvidersPricingGatewayController {
  private readonly logger = new Logger(ProvidersPricingGatewayController.name);

  constructor(private readonly pricingService: ProvidersPricingGatewayService) {}
