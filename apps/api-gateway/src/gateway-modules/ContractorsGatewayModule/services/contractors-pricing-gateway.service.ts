...
@Injectable()
export class ContractorsPricingGatewayService {
  private readonly logger = new Logger(ContractorsPricingGatewayService.name);
  private grpcService: PricingServiceGrpc;

  constructor(
    @Inject('CONTRACTORS_PRICING_PACKAGE') // Ensure this matches your ClientsModule configuration
    private readonly grpcClient: ClientGrpc,
  ) {
    this.grpcService = this.grpcClient.getService<PricingServiceGrpc>('ContractorsPricingService');
  }
