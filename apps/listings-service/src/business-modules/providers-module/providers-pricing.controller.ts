...
import { 
  ProvidersPricingService 
} from './providers-pricing.service';
import { 
...
export class ProvidersPricingController {
  private readonly logger = new Logger(ProvidersPricingController.name);

  constructor(private readonly pricingService: ProvidersPricingService) {}
