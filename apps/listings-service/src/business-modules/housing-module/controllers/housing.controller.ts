...
export class HousingController {
  ...
  async scheduleViewing(
    ...
    this.logger.debug(`📅 ScheduleViewing Request - User: ${data.callerId}, House: ${data.houseId}`);
   ...
   */
  @GrpcMethod('HousingService', 'ScheduleAdminViewing')
  async scheduleAdminViewing(
    data: ScheduleAdminViewingGrpcRequestDto,
  ): Promise<BaseResponseDto<HouseViewingResponseDto>> {
    ...
    return this.housingService.scheduleAdminViewing(data);
  }
